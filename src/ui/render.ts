...
export function renderHelp(): void {
  ...
  const commands = [
    ...
    ['/serve [port]', 'Start REST API server in background'],
    ['/multi-agent [port]', 'Start multi-agent API server (auto token)'],
    ['/services', 'List running background services'],
    ['/stop <name>', 'Stop a service (rest-api / multi-agent / all)'],
